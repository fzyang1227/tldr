        ...
        <Bot>
            <div className='px-1 container'>
                ...
                <div className="pt-2 row justify-between">
                    <label htmlFor="sentences" className="col-8 col-form-label">Summarize article # sentences:</label>
                    <div className='col-3'>
                    <Input type="number" className="form-control" id="sentences" min="1" max="30" value="7"/>
                    </div>
                </div>
                </form>
            </div>
